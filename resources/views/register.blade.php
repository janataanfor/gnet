                ...
                <div class="card-body ">
                    ...
                    {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg" id="name" name="name" placeholder="اسم الزبون">
                        </div>
                        <div class="form-group">
                            <label class="col-form-label float-right" for="formGroupExampleInput">الايميل</label>
                            <input type="email" class="form-control form-control-lg" id="email" name="email" placeholder="الايميل للدخول للموقع">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" max="9999" class="form-control form-control-lg" id="balance" name="balance" placeholder="إضافة رصيد">
                        </div>
