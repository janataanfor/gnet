    ...
    <div class="container">
        ...
        <div class="col-sm-6 mx-auto">
            ...
            <div class="card border-primary text-center">
                <div class="card-body ">
                    <form method="POST" action="/home/editecategory/{{$category->id}}">
                    {{csrf_field()}}
                       <!--  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-lg" value="{{$category->title}}" id="title" name="title" placeholder="اسم الفئة الذي يظهر للزبون">
                        </div>
                        <div class="form-group">
                            <label class="float-right" for="exampleFormControlTextarea1">التفاصيل:</label>
                            <textarea class="form-control form-control-lg"  id="description" name="description" rows="3">{{$category->description}}</textarea>
                        </div>
